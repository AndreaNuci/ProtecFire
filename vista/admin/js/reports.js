...
$("#btnGenerateReport").addEventListener("click", () => {
  ...
  // ❌ IoT: generación de reportes basada en alertas, lecturas y dispositivos
  /*
  if (type === "alertas") {
  ...
  */
  ...
  // ✅ UI: mensaje genérico sin datos IoT
  html += `
    <div><i>Generación de reporte deshabilitada (IoT comentado)</i></div>
  `;
...
// ❌ IoT: exportación de datos reales de alertas a CSV
/*
