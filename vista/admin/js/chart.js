...
$$(".segmented__btn").forEach(btn => {
  btn.addEventListener("click", () => {
    ...
    // ❌ IoT: cambio dinámico del tipo de gráfico según estado/dato del sistema
    /*
...
// ❌ IoT: construcción de tendencia a partir de datos de zonas/sensores
/*
...
function initTrendChart(recreate = false) {
  ...
  // ❌ IoT: recreación del gráfico ligada al flujo dinámico de datos
  /*
  ...
  */
  ...
  // ❌ IoT: etiquetas y datasets construidos desde datos de sensores
  /*
  ...
  */
  ...
  // ✅ UI: gráfico visual con datos vacíos de ejemplo
...
// ❌ IoT: actualización del gráfico con datos de tendencia del sistema
/*
