...
// ❌ IoT: zonas monitoreadas con últimas lecturas
/*
let zones = [
...
// ❌ IoT: inventario de dispositivos
/*
let devices = [
...
// ❌ IoT: historial de alertas del sistema
/*
let alerts = [
...
// ❌ IoT: serie temporal de lecturas
/*
let trend = [];
*/

// ✅ UI/chart: tipo de gráfico seleccionado
let chartType = "line";

// ✅ UI/chart: instancia del gráfico
let trendChart = null;