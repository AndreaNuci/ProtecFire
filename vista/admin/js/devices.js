...
function renderDevicesTable() {
  ...
  // ❌ IoT: construcción de filas desde datos reales de dispositivos
  /*
  ...
  */
  ...
  // ✅ Vista activa sin lógica IoT
  tbody.innerHTML = `
    <tr>
      <td colspan="7" style="text-align:center;">Datos de dispositivos deshabilitados (IoT comentado)</td>
    </tr>
  `;

  // ❌ IoT: acciones ligadas al identificador del dispositivo
  /*
...
// ❌ IoT: búsqueda y carga de detalle de un dispositivo
/*
...
// ❌ IoT: edición de datos del dispositivo
/*
...
// ❌ IoT: alta de nuevos dispositivos
/*
