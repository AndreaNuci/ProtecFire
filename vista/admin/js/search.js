...
$("#globalSearch").addEventListener("input", (e) => {
  ...
  if (!q) {
    // ❌ IoT: restaurar render completo con datos del sistema
    /*
    renderAll();
    */
    return;
  ...
  // ❌ IoT: filtrado de alertas del sistema
  /*
  ...
  */
  ...
  // ❌ IoT: filtrado de dispositivos del sistema
  /*
  ...
  */
  ...
  if ($("#view-alerts").classList.contains("is-visible")) {
    // ❌ IoT: render de resultados de alertas filtradas
    /*
  ...
  if ($("#view-devices").classList.contains("is-visible")) {
    // ❌ IoT: render de resultados de dispositivos filtrados
    /*
...
// ✅ App/UI: confirmación visual de cierre de sesión
