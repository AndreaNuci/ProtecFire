                    ...
                    <form>
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-4">
                                ...
                                <input type="text" class="form-control input-contacto">
                            </div>

                            <div class="col-md-6 mb-4">
                                <label class="form-label">Correo electrónico</label>
                                <input type="email" class="form-control input-contacto">
                            </div>

                            <div class="col-12 mb-4">
                                <label class="form-label">Mensaje</label>
                                <textarea rows="5" class="form-control input-contacto"></textarea>
                            </div>
...
<!-- Ruta corregida -->
<script src="js/cajitas.js"></script>
